!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? (module.exports = t(require("@popperjs/core"), require("bootstrap")))
    : "function" == typeof define && define.amd
    ? define(["@popperjs/core", "bootstrap"], t)
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).nifty =
        t(e.core, e.bootstrap));
})(this, function (t, i) {
  "use strict";
  const n = {
  ...
  class e {
    constructor(e, t) {
      if (
        e &&
        "object" == typeof e &&
        ((this._element = e), (this._parent = e.parentElement), t)
      ) {
        this._listener = {};
        for (const i in (t =
          "string" == typeof t ? { action: (t = o.trim(t).split(",")) } : t)) {
    ...
    _createHandler(t, s) {
      try {
        ...
        throw new Error(
          `Add a listener function called "${s}" to handle the ${t.toString()} event.`
        );
      }
      for (const e of t)
        (this._listener[e] = s), this._element.addEventListener(e, this[s], !1);
    }
    dispose() {
  ...
  class r extends e {
    constructor(e, t) {
      ...
      super(e, t.event),
        ...
        (this._target =
          ...
          n.findOne(this._element.getAttribute(this._config.dataTargetKey))),
        this._element.getAttribute(this._config.dataTargetKey) ||
          console.error(
        ...
        (this._toggleClass = this._element.getAttribute(
          this._config.dataClassKey
        )),
    ...
    _actionHandler() {
      "FullScreen" == this._toggleType
        ? this._fullscreen()
        : "FullPage" == this._toggleType
        ? this._fullpage()
        : "Dismiss" == this._toggleType
        ? this._dismiss()
        : "Class" == this._toggleType && this._class(),
        (this._status = this._updateStatus());
    }
    _getToggleType() {
      for (const e in this._config.toggleMode)
        if (
          this._element.getAttribute(this._config.dataKey) ==
          this._config.toggleMode[e]
        )
          return e;
    }
    _updateStatus() {
      return "FullScreen" == this._toggleType
        ? document.fullscreenElement
          ? "fullscreen"
          : "normal"
        : "FullPage" == this._toggleType
        ? this._target.classList.contains("content-full-page")
          ? "fullpage"
          : "normal"
        : "Dismiss" == this._toggleType
        ? this._target
          ? "normal"
          : "dismissed"
        : "Class" == this._toggleType
        ? this._target.classList.contains(this._toggleClass)
          ? "added"
          : "removed"
        : void 0;
    }
  ...
  class l extends e {
    constructor(e) {
      super(e, { show: "show.bs.dropdown", hide: "hide.bs.dropdown" }),
    ...
    _hideHandler() {
      ...
      this._menu.getAttribute("data-bs-popper") &&
  ...
  class p extends e {
    constructor(e, t) {
      ...
      super(e, t.event),
        ...
        (this._toggleType = e.classList.contains(
          this._config.selectorToggleNav.replace(".", "")
        )
          ? "NAV"
          : "SIDEBAR"),
        (this._removeBackdrop = this._removeBackdrop.bind(this)),
        (this._eventSidebarsChange = new Event(
          this._config.eventSidebarsChange
        )),
        (this._eventSidebarsChanged = new Event(
    ...
    _actionHandler(e) {
      e.stopPropagation(),
        "NAV" == this._toggleType
          ? window.innerWidth < 992 ||
            (!this._root.classList.contains(d) &&
              !this._root.classList.contains(_))
            ? (this._root.classList.toggle(g),
              document.addEventListener(c, this._removeBackdrop, !1))
            : (this._root.classList.toggle(d), this._root.classList.toggle(_))
          : (this._root.classList.toggle(u),
            document.addEventListener(c, this._removeBackdrop, !1)),
        this._dispatchEvent();
    }
    _dispatchEvent() {
      (this._transitionEnd = this._transitionEnd.bind(this)),
        ("NAV" == this._toggleType
          ? (this._nav.dispatchEvent(this._eventSidebarsChange), this._nav)
          : (this._sidebar.dispatchEvent(this._eventSidebarsChange),
            this._sidebar)
        ).addEventListener("transitionend", this._transitionEnd);
    }
    _transitionEnd(e) {
      ("max-width" != e.propertyName && "transform" != e.propertyName) ||
        (e.target == this._nav
          ? (this._nav.removeEventListener(
              "transitionend",
              this._transitionEnd
            ),
    ...
    _removeBackdrop(e) {
      (e.target !== this._root &&
        ...
        (this._root.classList.remove(g),
        this._root.classList.contains("sb--stuck") ||
          this._root.classList.remove(u),
        this._dispatchEvent(),
  ...
  const f = {
    ...
    b = {
      ...
      modifiers: [
        ...
        { name: "arrow", options: { padding: 15 } },
        { name: "preventOverflow", options: { padding: 7 } },
      ],
    },
    C = {
      maxi: "mn--max",
  ...
  class y extends e {
    ...
    static get mode() {
      var e = n.findOne(v);
      for (const t in C) if (e.classList.contains(C[t])) return t;
    }
    static setmode(e) {
      if (S) {
    ...
    _navChangeHandler() {
      this._updateNavMode(),
        this._navSubmenus.forEach((e) => {
          "mini" == this._mode && e._element.classList.contains("show")
            ? e._bsCollapse.hide()
            : "mini" != this._mode &&
              e._popper &&
              (e._popper.destroy(), (e._popper = void 0));
        });
    }
    _navChangedHandler() {
      "mini" != this._mode &&
        this._navSubmenus.forEach((e) => {
          "maxi" == this._mode
            ? e._isLink ||
              (!e._parent.classList.contains("open") &&
                !e._toggler.classList.contains("active")) ||
              e._bsCollapse.show()
            : e._isLink ||
              this._root.classList.contains("mn--show") ||
              (e._parent.classList.contains("open") ||
              e._toggler.classList.contains("active")
                ? ((e._collapseConfigParent = e._bsCollapse._config.parent),
                  (e._bsCollapse._config.parent = null),
                  e._bsCollapse.show(),
                  (e._bsCollapse._config.parent = e._collapseConfigParent))
                : e._bsCollapse.hide());
        });
    }
    _updateSelectors() {
      (this._root = n.findOne(this._config.selectorRoot)),
        (this._submenus = n.find(
    ...
    _initializeCollapseMenu() {
      this._navSubmenus = this._submenus.map(
        (e) => new E(e, this._config, this)
      );
    }
    _addListenerClickOutside() {
      this._isListenerAdded ||
        ((this._isListenerAdded = !0),
        (this._isOutsideNavigation = this._isOutsideNavigation.bind(this)),
        this._config.eventOutsideTrigger.forEach((e) =>
          document.addEventListener(e, this._isOutsideNavigation, !1)
        ));
    }
    _removeListenerClickOutside() {
      this._isListenerAdded &&
        ((this._isListenerAdded = !1),
        this._config.eventOutsideTrigger.forEach((e) =>
          document.removeEventListener(e, this._isOutsideNavigation)
        ));
    }
    _isOutsideNavigation(e) {
      (e.target !== this._root && e.target.closest(this._config.selectorNav)) ||
        (this._navSubmenus.forEach((e) => e._bsCollapse.hide()),
  ...
  class E extends e {
    ...
    _submenuToggle(e) {
      e.stopPropagation(),
        ("mini" != this._mainnav._mode && "mouseenter" == e.type) ||
          (this._isLink || e.preventDefault(),
    ...
    _hideHandler() {
      ...
      (this._element.contains(this._mainnav.called) &&
        ...
        (this._isLink || this._toggler.classList.add("collapsed"),
        "mini" == this._mainnav._mode &&
          this._childCollapse.length &&
          (e = n.findOne(
    ...
    _shownHandler() {
      "mini" == this._mainnav._mode
        ? (this._popper.update(), this._mainnav._addListenerClickOutside())
  ...
  class A extends e {
    constructor(e, t) {
      ...
      super(e, t.event),
        ...
        (this._config = t),
        (this._icons = n.find(
          this._config.selectorSwitcherIcons,
          this._parent
        )),
    ...
    _actionHandler(e) {
      e = e.currentTarget;
      (T =
        "checkbox" == e.type && null == e.getAttribute("value")
          ? e.checked
            ? "dark"
            : "light"
          : e.value),
    ...
    _updateState() {
      if (
        (this._updateColorMode(),
        "checkbox" == this._element.type &&
          null == this._element.getAttribute("value"))
      )
        ...
        var e;
        ("radio" != this._element.type && "checkbox" != this._element.type) ||
          ((this._element.checked = this._element.value == this._colorMode),
          "auto" == T &&
            ((e = document.querySelector(
              `[name="${this._element.getAttribute("name")}"][value="auto"]`
            ))
              ? (e.checked = !0)
              : "checkbox" == this._element.type &&
                "auto" == this._element.value &&
                (this._element.checked = !0)));
      }
      this._icons.forEach((e) => {
        e.classList.contains("icon-" + this._colorMode)
    ...
    dispose() {
      ...
      -1 < e && M.splice(e, 1), super.dispose();
    }
  }
  return (
    n.find(s).forEach((e) => new A(e)),
    {
      Toggler: r,
      SmoothDropdown: l,
      SidebarToggler: p,
    ...
    t.addEventListener("click", (e) => {
      e.preventDefault(),
        t.classList.contains(".active") ||
          ((e = document.querySelector("._dm-boxbg__thumb.active ")) &&
...
if (document.getElementById("_dm-settingsContainer")) {
  const f = {
    ...
    n =
      ([...document.querySelectorAll("._dm-offcanvasBtn")].map((e) => {
        e.addEventListener("click", () => {
          (j.className = "offcanvas " + e.value),
            (j.style = "transition-duration: 0s"),
            l.dispatchEvent(new Event("click")),
            m.addEventListener(
              "transitionend",
              () => {
                (j.style = ""), k.show();
    ...
    r =
      (p.forEach((e) => {
        e.getAttribute("data-color") == q && e.classList.add("active"),
          e.addEventListener("click", (e) => {
            document.documentElement.setAttribute(
              "data-scheme",
              e.currentTarget.getAttribute("data-color")
            ),
              o.querySelector(".active").classList.remove("active"),
    ...
    v =
      (s.forEach((e) => {
        e.getAttribute("data-color-mode") == u && e.classList.add("active"),
          e.addEventListener("click", (e) => {
            e = e.currentTarget;
    ...
    x = (e, t, a, o) => {
      ...
      (t.innerHTML = "" + a + d + o),
        (t.style.left = `calc(${e}% + (${8 - 0.15 * e}px))`);
    },
    y =
      (x(v, w, "", "px"),
      v.addEventListener("input", (e) => {
        x(e.currentTarget, w, "", "px"),
    ...
    B = {
      ...
      overflowBehavior: { x: "visible-scroll" },
    },
    C = () =>
      new Promise((t, a) => {
        if (document.getElementById("_dm-jsOverlayScrollbars")) t("done");
          ...
          e.setAttribute("id", "_dm-cssOverlayScrollbars"),
            ...
            e.setAttribute(
              "href",
              A + "/vendors/overlayscrollbars/overlayscrollbars.min.css"
            ),
            document.querySelector("head").append(e),
            (e = document.createElement("script")).setAttribute(
              "id",
              "_dm-jsOverlayScrollbars"
            ),
            e.setAttribute(
              "src",
              A +
                "/vendors/overlayscrollbars/overlayscrollbars.browser.es6.min.js"
            ),
