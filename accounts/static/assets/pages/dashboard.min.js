...
document.addEventListener("DOMContentLoaded", () => {
  updateColorVars(),
    (networkChart = new Chart(document.getElementById("_dm-networkChart"), {
      type: "line",
      data: {
        datasets: [
          {
            ...
            fill: "start",
            parsing: { xAxisKey: "period", yAxisKey: "up" },
          },
          {
            ...
            fill: "start",
            parsing: { xAxisKey: "period", yAxisKey: "dl" },
          },
        ],
      },
      options: {
        ...
        scales: {
          y: { display: !1, suggestedMax: 200 },
          x: {
            grid: { borderWidth: 0, drawOnChartArea: !1 },
            ticks: {
              font: { size: 11 },
              color: textColor,
              autoSkip: !0,
  ...
  const e = new Chart(document.getElementById("_dm-hddChart"), {
      type: "line",
      data: {
        datasets: [
          {
            ...
            fill: "start",
            parsing: { xAxisKey: "period", yAxisKey: "hddSpace" },
          },
        ],
      },
      options: {
          ...
          tooltip: {
            ...
            callbacks: {
              label: (e) => {
                ...
                return (
                  e.parsed.y !== null && (t += " : " + e.parsed.y + "%"), t
                );
              },
            },
          },
    ...
    t = new Chart(document.getElementById("_dm-earningChart"), {
      type: "line",
      data: {
        datasets: [
          {
            ...
            borderWidth: 2,
            borderColor: "white",
            parsing: { xAxisKey: "period", yAxisKey: "earning" },
          },
        ],
      },
      options: {
          ...
          tooltip: {
            ...
            callbacks: {
              label: (e) => {
                let t = e.dataset.label || "";
                return (
                  e.parsed.y !== null && (t += " : $" + e.parsed.y + ".00"), t
                );
              },
            },
          },
    ...
    n = new Chart(document.getElementById("_dm-salesChart"), {
      type: "bar",
      data: {
        datasets: [
          {
        ...
        plugins: {
          ...
          tooltip: {
            ...
            callbacks: {
              label: (e) => {
                let t = e.dataset.label || "";
                return e.parsed.y !== null && (t += ` ${e.parsed.y} Sales`), t;
              },
            },
          },
        },
    ...
    s = new Chart(document.getElementById("_dm-taskChart"), {
      type: "bar",
      data: {
        datasets: [
          {
            ...
            parsing: { yAxisKey: "kind", xAxisKey: "complete" },
          },
        ],
      },
      options: {
...
["change.nf.colormode", "scheme-changed"].forEach((e) =>
  document.addEventListener(e, updateDashboardChart)
);
let getSecondaryColor = (e) => {
  e = e.split(",");
  let n = e[0] / 255,
    s = e[1] / 255,
    i = e[2] / 255,
    o = Math.max(n, s, i),
    t = o - Math.min(n, s, i),
    r = 1 - Math.abs(o + o - t - 1),
    a =
      t && (o == n ? (s - i) / t : o == s ? 2 + (i - n) / t : 4 + (n - s) / t),
    c = getBgLightness();
  return hslToHex(
    Math.round(60 * (a < 0 ? a + 6 : a)),
    c > 70 ? Math.round(r ? t / r : 0 * 100) + 30 : 15,
    c > 70 ? 0.9 : 0.25
  );
};
function hslToHex(e, t, n) {
  const o = (t * Math.min(n, 1 - n)) / 100,
    s = (t) => {
      const s = (t + e / 30) % 12,
        i = n - o * Math.max(Math.min(s - 3, 9 - s, 1), -1);
...
let getBgLightness = () => {
    let e = _body.getPropertyValue("--bs-component-bg-rgb").split(",");
    (e[0] /= 255), (e[1] /= 255), (e[2] /= 255);
    let t = Math.max(e[0], e[1], e[2]),
      n = t - Math.min(e[0], e[1], e[2]);
    return Math.round(((t + t - n) / 2) * 100);
  },
  updateColorVars = () => {
    (primaryColor = _body.getPropertyValue("--bs-primary")),
      (textColor = _body.getPropertyValue("--bs-body-color")),
      (secondaryColor = getSecondaryColor(
        _body.getPropertyValue("--bs-primary-rgb")
      ));
  };
